          ...
          <div className="mx-auto max-w-4xl p-6 md:p-12">
            <header className="mb-10">
              ...
              <div className="flex flex-wrap items-center gap-3 text-sm text-slate-500">
                ...
                {pageData.tags.map((tag) => <span key={tag} className="flex items-center gap-1 rounded bg-indigo-50 px-2 py-1 text-[11px] font-bold text-indigo-600"><Tag size={12} /> {tag}</span>)}
              </div>
            </header>
