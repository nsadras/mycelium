...
**Current state:** implementation resumed with E1 evaluation and current-contract
cleanup. Items remain open until their acceptance evidence is recorded below. Existing
